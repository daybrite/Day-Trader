...
data_demo = بيانات تجريبية مخزَّنة
...
settings_proxy_hint = تمر طلبات الأسعار عبره. استخدم %u في موضع إدراج رابط Yahoo كاملًا، أو %p لإدراج مساره وحده؛ والقالب الخالي منهما يُعامل كبادئة. اتركه فارغًا لجلب Yahoo مباشرة — ويحجب المتصفح ذلك كطلب بين المواقع، فتعرض نسخة الويب البيانات التجريبية المرفقة.
settings_proxy_apply = تطبيق
settings_proxy_direct = جلب مباشر
settings_demo_label = استخدام البيانات التجريبية المخزَّنة
settings_demo_hint = يقرأ أسعار الأمثلة المرفقة بالتطبيق بدل جلبها. وتستخدمها نسخة الويب من تلقاء نفسها ما لم يُعيَّن وسيط.
demo_notice_no_proxy = يتم عرض بيانات تجريبية مخزَّنة لعدم تعيين وسيط لطلبات الويب.
demo_notice_chosen = يتم عرض بيانات تجريبية مخزَّنة، وفق اختيارك في الإعدادات.
